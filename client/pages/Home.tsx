            ...
            >
              <g filter="url(#filter0_d_2360_4938)">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M25 7V21L12.5 28L0 21V7L12.5 0L25 7ZM2.37305 8.39062V19.6084L9.30888 23.493V20.1581L5.53056 18.16L4.89873 17.8261V10.1737L5.53056 9.83973L9.30888 7.84071V4.50669L2.37305 8.39062ZM11.6819 18.7294V24.8221L12.5 25.2803L13.3186 24.8219V18.7296L13.9505 18.3956L17.7288 16.3956V15.5557H20.1018V17.8253L19.47 18.1602L15.6917 20.1583V23.493L22.627 19.6094V8.38965L15.6917 4.50669V7.83991L19.47 9.83991L20.1018 10.1739V12.4444H17.7288V11.6026L13.9505 9.60456L13.3186 9.2696V3.17806L12.5 2.71973L11.6819 3.17783V9.2704L11.0501 9.60438L7.27178 11.6024V16.3964L11.0501 18.3954L11.6819 18.7294Z"
                  fill="#2F66F6"
                />
              </g>
              <defs>
                <filter
                  id="filter0_d_2360_4938"
                  x="0"
                  y="0"
                  width="25"
                  height="29"
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_2360_4938"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_2360_4938"
                    result="shape"
                  />
                </filter>
              </defs>
            </svg>
            <span className="text-lg font-semibold text-[#2F66F6]">
              coinmoney
            </span>
          </div>
      ...
      <div className="px-4 pb-20">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-[#11183C] text-base font-medium">
              Market Movers
            </h2>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#D7D9E4]">
        <div className="flex">
          ...
          >
            ...
            >
              <path
                d="M14.9143 23C14.9143 23.4418 15.2725 23.8 15.7143 23.8C16.1561 23.8 16.5143 23.4418 16.5143 23H14.9143ZM8.48571 23C8.48571 23.4418 8.84389 23.8 9.28571 23.8C9.72754 23.8 10.0857 23.4418 10.0857 23H8.48571ZM10.5714 16.3228H14.4286V14.7228H10.5714V16.3228ZM14.9143 16.769V23H16.5143V16.769H14.9143ZM8.48571 16.769V23H10.0857V16.769H8.48571Z"
                fill="#2F66F6"
              />
            </svg>
          ...
          >
            ...
            >
              <path
                d="M10.3268 12.482L9.6612 12.0382L10.3268 12.482Z"
                fill="#696F8C"
              />
            </svg>
