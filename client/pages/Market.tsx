    ...
    <div className="min-h-screen bg-[#F8F9FC]">
      ...
      <div className="bg-[#F8F9FC] px-4 py-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-lg font-medium text-[#11183C]">Market</h1>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <div className="px-4 pb-20">
        ...
        <div className="flex gap-2 mb-4 overflow-x-auto">
          <Button
            variant="ghost"
            className="bg-[#2F66F6] text-white px-4 py-2 rounded-lg text-sm whitespace-nowrap"
          >
            All
          </Button>
          <Button
            variant="ghost"
            className="bg-white text-[#696F8C] px-4 py-2 rounded-lg text-sm whitespace-nowrap"
          >
            Favorites
          </Button>
          <Button
            ...
            <Card key={index} className="shadow-sm">
              <CardContent className="flex items-center justify-between p-4">
                    ...
                    className={`w-10 h-10 rounded-full flex items-center justify-center ${
                      item.symbol.includes("BTC")
                        ...
                        : item.symbol.includes("ETH")
                          ? "bg-blue-500"
                          : item.symbol.includes("SOL")
                            ? "bg-gradient-to-br from-purple-400 to-blue-500"
                            : item.symbol.includes("ADA")
                              ? "bg-blue-600"
                              : item.symbol.includes("DOT")
                                ? "bg-pink-500"
                                : "bg-purple-500"
                    }`}
                  >
                ...
                <div className="text-right">
                  ...
                  <p
                    className={`text-sm ${item.isPositive ? "text-[#098C26]" : "text-[#CD0000]"}`}
                  >
                    {item.change}
                  </p>
                </div>
        ...
        {/* Market Stats */}
        <div className="mt-8">
          <h3 className="text-base font-medium text-[#11183C] mb-4">
            Market Overview
          </h3>
          <div className="grid grid-cols-2 gap-4">
            <Card className="shadow-sm">
              <CardContent className="p-4 text-center">
                <p className="text-[#696F8C] text-sm">Market Cap</p>
                <p className="text-[#11183C] text-lg font-medium">$1.2T</p>
                <p className="text-[#098C26] text-xs">+2.4%</p>
              </CardContent>
            </Card>
            <Card className="shadow-sm">
              <CardContent className="p-4 text-center">
                <p className="text-[#696F8C] text-sm">24h Volume</p>
                <p className="text-[#11183C] text-lg font-medium">$89.5B</p>
                <p className="text-[#CD0000] text-xs">-1.2%</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="flex">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
              <path
                d="M14.9143 23C14.9143 23.4418 15.2725 23.8 15.7143 23.8C16.1561 23.8 16.5143 23.4418 16.5143 23H14.9143ZM8.48571 23C8.48571 23.4418 8.84389 23.8 9.28571 23.8C9.72754 23.8 10.0857 23.4418 10.0857 23H8.48571Z"
                fill="#696F8C"
              />
            </svg>
          ...
          >
            <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
              <path
                d="M8.5 6L4.5 10H20.5M16.5 19L20.5 15H3.5"
                stroke="#696F8C"
                strokeWidth="1.6"
                strokeLinecap="round"
              />
          ...
          >
            <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
              <path
                d="M10.3268 12.482L9.6612 12.0382L10.3268 12.482ZM6.27881 17.1118C6.03372 17.4794 6.13306 17.9761 6.50069 18.2212C6.86831 18.4663 7.365 18.3669 7.61009 17.9993L6.27881 17.1118ZM18.7212 9.11043C18.9663 8.7428 18.8669 8.24611 18.4993 8.00103C18.1317 7.75594 17.635 7.85528 17.3899 8.22291L18.7212 9.11043ZM14.6732 13.7403L15.3388 14.184L14.6732 13.7403ZM12.7549 13.6208L13.4704 13.2631L12.7549 13.6208ZM12.2451 12.6014L12.9607 12.2436L12.2451 12.6014ZM9.6612 12.0382L6.27881 17.1118L7.61009 17.9993L10.9925 12.9257L9.6612 12.0382ZM17.3899 8.22291L14.0075 13.2965L15.3388 14.184L18.7212 9.11043L17.3899 8.22291ZM13.4704 13.2631L12.9607 12.2436L11.5296 12.9592L12.0393 13.9786L13.4704 13.2631ZM14.0075 13.2965C13.875 13.4953 13.5772 13.4767 13.4704 13.2631L12.0393 13.9786C12.6956 15.2911 14.5248 15.405 15.3388 14.184L14.0075 13.2965ZM10.9925 12.9257C11.125 12.727 11.4228 12.7455 11.5296 12.9592L12.9607 12.2436C12.3044 10.9311 10.4752 10.8173 9.6612 12.0382L10.9925 12.9257Z"
                fill="#2F66F6"
              />
            </svg>
