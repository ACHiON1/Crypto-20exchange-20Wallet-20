...
export default function MarketPage() {
  ...
  const marketData = [
    ...
    { symbol: "ADA/USDT", price: "0.2876", change: "+0.89%", volume: "89,234,567.12", isPositive: true },
    { symbol: "DOT/USDT", price: "4.23", change: "-2.15%", volume: "67,890,123.45", isPositive: false },
    { symbol: "MATIC/USDT", price: "0.5234", change: "+4.12%", volume: "78,567,234.56", isPositive: true },
  ];
    ...
    <div className="min-h-screen bg-[#F8F9FC]">
      ...
      <div className="px-4 pb-20">
        ...
        <div className="flex gap-2 mb-4 overflow-x-auto">
          <Button variant="ghost" className="bg-[#2F66F6] text-white px-4 py-2 rounded-lg text-sm whitespace-nowrap">
            All
          </Button>
          <Button variant="ghost" className="bg-white text-[#696F8C] px-4 py-2 rounded-lg text-sm whitespace-nowrap">
            Favorites
          </Button>
          <Button variant="ghost" className="bg-white text-[#696F8C] px-4 py-2 rounded-lg text-sm whitespace-nowrap">
            Spot
              ...
              <CardContent className="flex items-center justify-between p-4">
                <div className="flex items-center space-x-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    ...
                    item.symbol.includes('SOL') ? 'bg-gradient-to-br from-purple-400 to-blue-500' :
                    item.symbol.includes('ADA') ? 'bg-blue-600' :
                    item.symbol.includes('DOT') ? 'bg-pink-500' :
                    'bg-purple-500'
                  }`}>
                    <span className="text-white font-bold text-sm">
                      {item.symbol.includes('BTC') ? '₿' :
                       item.symbol.includes('ETH') ? 'E' :
                       item.symbol.includes('SOL') ? 'S' :
                       item.symbol.includes('ADA') ? 'A' :
                       item.symbol.includes('DOT') ? 'D' :
                       'M'}
                    </span>
                  </div>
                  <div>
        ...
        {/* Market Stats */}
        <div className="mt-8">
          <h3 className="text-base font-medium text-[#11183C] mb-4">Market Overview</h3>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#D7D9E4]">
        <div className="flex">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
              <path d="M10.3268 12.482L9.6612 12.0382L10.3268 12.482ZM6.27881 17.1118C6.03372 17.4794 6.13306 17.9761 6.50069 18.2212C6.86831 18.4663 7.365 18.3669 7.61009 17.9993L6.27881 17.1118ZM18.7212 9.11043C18.9663 8.7428 18.8669 8.24611 18.4993 8.00103C18.1317 7.75594 17.635 7.85528 17.3899 8.22291L18.7212 9.11043ZM14.6732 13.7403L15.3388 14.184L14.6732 13.7403ZM12.7549 13.6208L13.4704 13.2631L12.7549 13.6208ZM12.2451 12.6014L12.9607 12.2436L12.2451 12.6014ZM9.6612 12.0382L6.27881 17.1118L7.61009 17.9993L10.9925 12.9257L9.6612 12.0382ZM17.3899 8.22291L14.0075 13.2965L15.3388 14.184L18.7212 9.11043L17.3899 8.22291ZM13.4704 13.2631L12.9607 12.2436L11.5296 12.9592L12.0393 13.9786L13.4704 13.2631ZM14.0075 13.2965C13.875 13.4953 13.5772 13.4767 13.4704 13.2631L12.0393 13.9786C12.6956 15.2911 14.5248 15.405 15.3388 14.184L14.0075 13.2965ZM10.9925 12.9257C11.125 12.727 11.4228 12.7455 11.5296 12.9592L12.9607 12.2436C12.3044 10.9311 10.4752 10.8173 9.6612 12.0382L10.9925 12.9257Z" fill="#2F66F6"/>
            </svg>
