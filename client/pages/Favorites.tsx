      ...
      <div className="px-4 pb-20">
        {favoriteCoins.length > 0 ? (
                ...
                <Card key={index} className="shadow-sm">
                  <CardContent className="flex items-center justify-between p-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-[#11183C] font-medium">
                          {item.symbol}
                        </p>
                        <p className="text-[#696F8C] text-xs">
                          Vol: {item.volume}
                        </p>
                      </div>
                    </div>
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-medium text-[#11183C] mb-2">
              No Favorites Yet
            </h3>
            <p className="text-[#696F8C] mb-4">
              Start adding your favorite cryptocurrencies to track them easily
            </p>
            <Button
              onClick={() => navigate("/market")}
              className="bg-[#2F66F6] hover:bg-[#2F66F6]/90"
            >
              Browse Market
            </Button>
          </div>
